...
function manageMenu() {
	...
	log_prompt "Git 仓库地址: https://github.com/angristan/openvpn-install"
	...
	log_menu "   3) 撤销现有用户"
	log_menu "   4) 更新证书"
	log_menu "   5) 删除 OpenVPN"
	log_menu "   6) 列出已连接的客户端"
	log_menu "   7) 退出"
	until [[ ${MENU_OPTION:-$menu_option} =~ ^[1-7]$ ]]; do
		read -rp "选择一个选项 [1-7]: " menu_option
	done
