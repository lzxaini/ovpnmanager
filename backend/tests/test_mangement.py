...
settings = {
    ...
    "openvpn_status_path": Path("/var/log/openvpn/openvpn-status.log"),
    "openvpn_management_host": "127.0.0.1",
    "openvpn_management_port": 7505,
    "openvpn_crl_path": Path("/etc/openvpn/crl.pem"),
    "openvpn_client_export_path": Path("/etc/openvpn/client-configs"),
    "ta_key_path": Path("/etc/openvpn/server/ta.key"),
    "server_conf_path": Path("/etc/openvpn/server.conf"),
}
